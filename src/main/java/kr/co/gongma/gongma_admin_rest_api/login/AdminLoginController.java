...
public class AdminLoginController {
    ...
    @PostMapping("/login")
    public AdminResponseDto login(@RequestBody AdminLoginDto request, HttpServletRequest httpServletRequest) throws ApiException {
        return adminLoginWriteService.login(request, httpServletRequest);
    }

    @Operation(summary = "로그인 기록 열람")
    @GetMapping("/login/history")
    public List<AdminLoginHistoryDto> getLoginHistory(@RequestParam Long adminId) throws ApiException {
